...
// const HERO_IMAGES = ['/images/1.jpg', '/images/hero2.jpg', '/images/hero3.jpg'];
...
// const HERO_IMAGES = ['/public/images/1.jpg', '/images/1.jpg', '/images/1.jpg'];
...
//   return (
//     <div className="min-h-screen flex flex-col bg-white text-gray-900">
//       {/* Header - plain white (no hero bg here) */}
...
//               </button>
//               {menuOpen && (
//                 <div className="absolute right-0 mt-2 bg-white shadow rounded p-4 w-48">
//                   <Link href="/" onClick={() => setMenuOpen(false)} className="block py-2 text-gray-700">
//                     Home
//                   </Link>
//                   <Link href="#about" onClick={() => setMenuOpen(false)} className="block py-2 text-gray-700">
...
//       {/* Hero (image limited to this hero container only) */}
//       <main className="flex-1">
//         <section
//           aria-label="Hero"
//           className="relative flex items-center justify-center h-[68vh] min-h-[420px] sm:h-[64vh] overflow-hidden"
//         >
//           {/* background image - only inside this section */}
//           <div className="absolute inset-0 -z-10">
//             <Image src={bgUrl} alt={`Hero ${bgIndex + 1}`} fill className="object-cover" priority />
//             {/* subtle white overlay to match your white+gray color scheme */}
...
//           {/* manual dots to jump to an image */}
//           <div className="absolute bottom-6 left-1/2 -translate-x-1/2 flex gap-2">
//             {HERO_IMAGES.map((_, i) => (
//               <button
//                 key={i}
      ...
      <main className="flex-1">
        ...
        >
          ...
          <div className="absolute inset-0 z-0">
            {/* fill image must be inside a positioned parent; this div is positioned (absolute) and sized by inset-0 */}
            <Image src={bgUrl} alt={`Hero ${bgIndex + 1}`} fill className="object-cover" priority />
